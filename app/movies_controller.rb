...
def can_be_created_in_a_block(args = {title: "Kill Bill", lead: "Uma Thurman"})
  Movie.create do |m|
    m.title = args[:title]
    m.lead = args[:lead]
  end
...
def can_find_using_where_clause_and_be_sorted
  ...
  Movie.where("release_date > ?", params[:date]).order(release_date: :desc)
end
